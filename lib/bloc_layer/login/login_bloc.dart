...
import 'package:demo_ican/data_layer/validators.dart';
...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  //We're overriding transformEvents in order to debounce
  // the EmailChanged and PasswordChanged events so that we give
  // the user some time to stop typing before validating the input
